...
public class HologramShaderGUI : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        GUILayoutCustom.Initialize(_material);
    ...
    void DrawGUI()
    {
        if (GUILayoutCustom.BeginFold((int)Category.General, "- Surface -"))
            DrawGeneralSettings();
        GUILayoutCustom.EndFold();

        if (GUILayoutCustom.BeginFold((int)Category.Effects, "- Effects -"))
        {
            DrawGeneralEffect();
            DrawRimSettings();
